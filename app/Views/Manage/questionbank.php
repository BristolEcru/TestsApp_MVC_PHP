...
<div class="container mt-6">
    <form method="POST" action="<?php echo route_to('createquiz'); ?>">
        <div class="row justify-content-center">
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <label for="quiz_name">2. Name new quiz:</label>
                    <input type="text" class="form-control" id="quiz_name" name="quiz_name" required><br>
                    <div class="block">
                        <label>3. </label>
