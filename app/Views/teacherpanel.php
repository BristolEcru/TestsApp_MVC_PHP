                    ...
                    <tbody>
                        <?php foreach ($questions as $question): ?>
                            <tr>
                                ...
                                <td>
                                    <a href="<?= site_url('/admin/edit_question/' . $question->question_number) ?>">Edit</a>
                                    <form action="<?= site_url('/admin/delete_question/' . $question->question_number) ?>"
                                        method="post"
